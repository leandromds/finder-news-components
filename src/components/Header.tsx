    ...
    <header>
      <div className="flex items-center justify-around bg-gray-900 h-20">
        ...
        <nav className="flex space-x-4">
          <a className="text-gray-50" href="#">item 1</a>
          <a className="text-gray-50" href="#">item 2</a>
          <a className="text-gray-50" href="#">item 3</a>
          <a className="text-gray-50" href="#">item 4</a>
          <a className="text-gray-50" href="#">item 5</a>
        </nav>
      </div>
      <div className="flex items-center justify-center bg-gray-700 h-20">
        <div className="relative text-gray-600 focus-within:text-gray-400 w-full max-w-[48rem]">
          ...
          <input
            ...
            placeholder="Busque pelas suas notícias aqui..."
            autoComplete="off"
